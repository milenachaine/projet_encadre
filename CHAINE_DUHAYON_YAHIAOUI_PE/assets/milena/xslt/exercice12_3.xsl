...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <body bgcolor="#81808E">
                <table align="center" width="90%" bgcolor="white" bordercolor="#3300FF" border="1">
                    ...
                    <tr bgcolor="#4E3A4A">
                        ...
                        <td><b>Contenu avec TAG</b> : <b><font color="red">forme</font></b><i>[<font color="blue">lemme</font>|<font color="green">cat</font>]</i></td>
                    </tr>
    ...
    <xsl:template match="element">
        ...
        <xsl:choose>
            <xsl:when test="(./data[contains(text(),'ADJ')]) and (following-sibling::element[1][./data[contains(text(),'ADJ')]])">
